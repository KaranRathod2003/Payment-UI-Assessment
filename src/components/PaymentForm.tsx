...
// import { savePaymentData } from "../stores/paymentStore"
...
//       class="max-w-md mx-auto p-6 bg-white rounded-lg shadow space-y-4"
//     >
//       <h2 class="text-2xl font-bold text-center">Payment Details</h2>
...
//           onInput={(e) => setForm({ ...form(), cardNumber: e.currentTarget.value })}
//         />
//         <Show when={errors().cardNumber}>
//           <p class="text-red-500 text-sm">{errors().cardNumber}</p>
//         </Show>
//       </div>
...
//           <p class="text-red-500 text-sm">{errors().expiryDate}</p>
//         </Show>
//       </div>
...
//           class="w-full border px-3 py-2 rounded"
//           value={form().cvv}
//           onInput={(e) => setForm({ ...form(), cvv: e.currentTarget.value })}
//         />
//         <Show when={errors().cvv}>
//           <p class="text-red-500 text-sm">{errors().cvv}</p>
//         </Show>
//       </div>
